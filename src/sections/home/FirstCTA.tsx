...
export const FirstCTA = () => {
  return (
    <div className="border-b min-w-full bg-background border-white/10 p-5">
      <div className="flex flex-col bg-[#191E4A] rounded-xl md:rounded-2xl items-center gap-4  max-sm:p-6 p-12 text-center sm:flex-row sm:justify-between sm:text-left">
        <div>
